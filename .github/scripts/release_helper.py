...
def main():
    ...
    repo = os.environ.get("REPO", "faserf/ha-pepper").lower()
    ...
    for path in ["custom_components/pepper/manifest.json", "pyproject.toml"]:
        try:
    ...
    for f in changed_files:
        if f.startswith("custom_components/pepper/translations/"):
            translation_count += 1
    ...
    body_parts = [
        f"# Pepper {version}  {channel_badge}",
        "",
        prerelease_note,
        "## 📋 What's Changed",
        "",
