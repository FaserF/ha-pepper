...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/pepper/__init__.py` |
| Coordinator | `custom_components/pepper/coordinator.py` |
| Options Flow | `custom_components/pepper/config_flow.py` |
| API Client | `custom_components/pepper/pepper_api.py` |
| Tests | `tests/` |
